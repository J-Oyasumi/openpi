    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        repack_transform = _transforms.Group(
            inputs=[
                _transforms.RepackTransform(
                    {
                        "observation/image": "fetch_head_image",
                        "observation/wrist_image": "fetch_hand_image",
                        "observation/state": "state",
                        "actions": "action",
                        "prompt": "prompt",
                    }
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        assets_base_dir="/media/chensixiang/Data/openpi/assets",
        checkpoint_base_dir="/media/chensixiang/Data/openpi/checkpoints",
        save_interval=10000,
        fsdp_devices=4,
    ),
]
